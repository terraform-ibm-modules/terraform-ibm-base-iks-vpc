...
<p>
  <a href="https://cloud.ibm.com/schematics/workspaces/create?workspace_name=base-iks-vpc-advanced-example&repository=https://github.com/terraform-ibm-modules/terraform-ibm-base-iks-vpc/tree/main/examples/advanced">
...
An advanced example which shows how to create a multi-zone KMS encrypted IKS VPC cluster with custom worker node taints.
...
- A multi-zone (3 zone) KMS encrypted IKS VPC cluster, with worker pools in each zone.
