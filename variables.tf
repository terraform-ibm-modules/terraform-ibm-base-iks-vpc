...
variable "access_tags" {
  type        = list(string)
  description = "Add access management tags to the cluster to control access. [Learn more](https://cloud.ibm.com/docs/account?topic=account-tag&interface=ui#create-access-console)."
  default     = []
  validation {
    condition = alltrue([
